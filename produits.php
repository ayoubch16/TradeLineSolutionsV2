...
if($t=='Terrain'){
    $typeb = empty($t) ? " " : "  `typeb`='Terrain/Construction' and `typeb`='Ferme Agricole' ";
}
...
where $typeb  `etatdel`='ND' ORDER BY `datecreation` desc ".$limit;
    ...
    $chercher = $_GET['chercher'];      
                    //  echo $sql1;
                     ...
                     $t = $_GET['typeb'];
                      ...
                      $sql1 = "SELECT * FROM `stockbien` where $typeb  $ville   $nature ( `nbrCham` between 0 and $NbrCham)  and (`nbrSalBain` between 0 and $NbrSalB )  and (`prixb` between $MinPrix  and $MaxPrix)  and `etatdel`='ND' ORDER BY `datecreation` desc";    
      } 
      ...
      if ($btnReff != null) {
            ...
            // $sql1="SELECT * FROM `stockbien` where Reff='$Reff'";
...
<li class=page-item><a id=p1 class=page-link href="produits.php?page=1">1</a></li>
<li class=page-item><a id=p2 class=page-link href="produits.php?page=2">2</a></li>
<li class=page-item><a id=p3 class=page-link href="produits.php?page=3">3</a></li>
<li class=page-item><a id=p4 class=page-link href="produits.php?page=4">4</a></li>
<li class=page-item><a id=p5 class=page-link href="produits.php?page=5">&#8594;</a></li>
</ul>
</nav>
</div>
<script></script>
